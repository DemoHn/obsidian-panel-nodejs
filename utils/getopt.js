// copied from node-getopt
// Since the original module can't be bundled correctly by enclose.js becuase of directory issues
// Thus we copy the whole file to the local to prevent this issue.
